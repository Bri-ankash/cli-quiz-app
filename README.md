...
- **Timer per question**: Default 15 seconds to answer each question
- **Colored terminal output**: Questions, correct answers, and incorrect answers highlighted
- **High scores**: Track scores per category with player names
